...
public class bagdastırıcı extends RecyclerView.Adapter<ViewHolder> {
    ListPerson liste;
    List<Model> modelliste;
   Context context;

    public bagdastırıcı(ListPerson liste, List<Model> modelliste) {
        this.listActivity = liste;
        this.modelList = modelliste;
    }
    @NonNull
    @Override
